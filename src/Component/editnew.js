...
import { GiTireIronCross, IconName } from "react-icons/gi";
...
const ViewStudent = () => {
  ...
  const addStudent = () => {
    ...
    content === "" ? console.log( inputStudent.total_fees === sum)  : console.log(content.content_id.total_fees === sum) 
    ...
    if (
      ...
      if (
        ...
        content === "" ?  inputStudent.total_fees === sum  : content.content_id.total_fees === sum
      ) {
        axios
          .put(
            `http://localhost:5000/course/updatestudentDetail/${id}`,
            {
              ...
              course_duration:content !== '' ? content.content_id.duration : inputStudent.course_duration,
                // content.content_id?.duration || inputStudent.course_duration,
              course_content:content !== '' ? content.content_id.content : inputStudent.course_content,
                // content.content_id?.content || inputStudent.course_content,
              total_fees: parseInt(content !== '' ? content.content_id.total_fees : inputStudent.total_fees),
  ...
  // Do anything else you need with the selected file.
              ...
              <div className="flex h-screen items-end justify-center px-4 py-2 text-center sm:items-center sm:p-0">
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-full lg:max-w-4xl md:max-w-2xl max-w-xl">
                  <div className="bg-gray-100 px-4 py-4 sm:p-6 sm:pb-4 sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="m-auto sm:m-0 w-8 hover:cursor-pointer hover:bg-gray-300 duration-300 p-2 rounded-full font-bold sm:mt-0" onClick={()=>{setViewCourceT(false); handleTabClick("tab1") ; setContent('')}}><GiTireIronCross className="font-bold"  /></div>
                  </div>
                  <div>
